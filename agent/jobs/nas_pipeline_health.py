...
# ---------------------------------------------------------------------------
_PIPELINE_SYSTEM = """\
You are a career-strategy advisor looking at Heath Blackmon's NAS trajectory. \
Given the metrics and recent activity, produce one concise briefing in markdown \
with these sections:
...
Total under 300 words. No cheerleading. Be quantitative."""
