...
GENERIC_LABELS = {
    ...
    "read_drive_file":         ("read",     "Read a research paper"),
    "read_local_file":         ("read",     "Read a research paper"),
    ...
    "list_sheets_in_spreadsheet": ("drive", "Queried a karyotype database"),
    "read_sheet":              ("drive",    "Queried a karyotype database"),
    "append_rows_to_sheet":    ("drive",    "Updated a karyotype database"),
    "update_sheet_cells":      ("drive",    "Updated a karyotype database"),
    "search_sheet":            ("drive",    "Queried a karyotype database"),
    ...
    "student_dashboard":       ("tool",     "Checked student research progress"),
    "log_milestone":           ("tool",     "Updated student milestone"),
    "log_interaction":         ("tool",     "Logged a meeting"),
    "students_needing_attention": ("tool",  "Checked on lab members"),
    ...
    # Paper of the day
    "get_paper_of_the_day":           ("read", "Read today's recommended paper"),
    ...
    "list_research_projects":          ("tool", "Reviewed active research projects"),
    "get_research_project":            ("tool", "Reviewed an active research project"),
    "add_research_project":            ("tool", "Added a research project"),
    "update_research_project":         ("tool", "Updated a research project"),
    "set_project_next_action":         ("tool", "Set the next research step"),
    "complete_project_next_action":    ("tool", "Completed a research step"),
    # Overnight grant drafter
    "list_overnight_drafts":           ("drive", "Reviewed overnight grant drafts"),
    "review_overnight_draft":          ("drive", "Marked draft reviewed"),
    # Database health
    "list_database_flags":             ("drive", "Audited a karyotype database"),
    "trigger_database_health_check":   ("drive", "Audited karyotype database integrity"),
    # Overnight comparative analysis
    "list_analysis_runs":              ("tool",  "Reviewed comparative analyses"),
    "get_analysis_run_detail":         ("tool",  "Reviewed a comparative analysis"),
    # Weekly hypothesis generator
    "list_hypothesis_proposals":       ("tool",  "Reviewed proposed hypotheses"),
    "adopt_hypothesis":                ("tool",  "Adopted a hypothesis"),
    "reject_hypothesis":               ("tool",  "Rejected a hypothesis"),
    "run_formal_hypothesis_pass":      ("tool",  "Evaluated a testable claim"),
    "record_chat_artifact":            ("tool",  "Logged a research artifact"),
    # Web fetching
    "fetch_url":                       ("read",  "Fetched a research reference"),
    "fetch_url_links":                 ("read",  "Surveyed a research site"),
    ...
    "epmc_cache_full_text":           ("read",   "Cached an open-access paper"),
    "s2_search_papers":               ("search", "Searched Semantic Scholar"),
    "gbif_bulk_occurrence_centroid":  ("tool",   "Computed species centroids"),
    "pubmed_batch_fetch":             ("read",   "Pulled records on a research topic"),
    "ncbi_assembly_summary":          ("tool",   "Reviewed a genome assembly"),
